...
class AssessmentRecord(Base):
    ...
    # 评估历程
    assessment_status = Column(SQLEnum(AssessmentStatus), default=AssessmentStatus.PENDING)
    assessment_mode = Column(String(50), default="immersive")  # immersive, traditional, etc.
...
class AssessmentMatchAnalysis(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    assessment_record_id = Column(Integer, ForeignKey("assessment_records.id"), nullable=False, index=True)
